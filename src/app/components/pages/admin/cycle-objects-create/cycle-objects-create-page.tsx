...
function CycleObjectsCreatePage({ className }: CycleObjectsCreatePageProps) {
  ...
  return (
    <Page>
      ...
      {/* Tiêu đề */}
      <h2 className=" mx-6 mt-6 text-[24px] font-bold text-mine-shaft mb-4">Thêm mới Sản phẩm chu kỳ</h2>
...
export default React.memo(withResourceBundle(CycleObjectsCreatePage, () => import('./translations')));
